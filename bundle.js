...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } // Viewの実装
...
},{"./actions/index.js":1,"fs":3,"redux":5}],3:[function(require,module,exports){
...
},{"_process":4,"symbol-observable":6}],6:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./ponyfill.js":7}],7:[function(require,module,exports){
'use strict';
